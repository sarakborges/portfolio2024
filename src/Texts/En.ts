...
export const HARD_SKILLS_TITLE = `Hard skills`
export const SOFT_SKILLS_TITLE = `Soft skills`
...
export const WORK_EXPERIENCES_TITLE = `Most relevant work experiences`
